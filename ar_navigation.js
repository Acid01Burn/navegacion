...
function render_elements() {
   $.ajax({
    url: `https://api.mapbox.com//directions/v5/mapbox/driving/${coordinates.source_lon}%2c${coordinates.source_lat}?alternatives=true&geometries=polyline&steps=true&acces_token=pk.eyJ1IjoiYXBvb3J2ZWxvdXMiLCJhIjoiY2ttZnlyMDgzMzlwNTJ4a240cmEzcG0xNyJ9.-nSyL0Gy2nifDibXJg4fTA`,
    type: "get",
